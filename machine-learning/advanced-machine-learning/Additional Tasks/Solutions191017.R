...
# Sample DAGs at random and, then, check which of them coincide with their CPDAGs, i.e. 
#the CPDAGs have no
# undirected edge (recall that a CPDAG has an undirected edge if and 
#only if there are two DAGs in the Markov
...
# If the robot observes a door, it can be in front of any of the three doors.
# If it then observes a long
